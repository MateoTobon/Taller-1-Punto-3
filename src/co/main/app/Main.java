...
public class Main {
	...
	public static void main(String[] args) {
		...
		Jugador barcos=new Jugador("Barcos", "Delantero");
		Jugador duarte=new Jugador("Duarte", "Delantero");
		Jugador cepellini=new Jugador("Cepellini", "MedioCampista");
		Jugador cuadrado=new Jugador("Cuadrado", "Arquero");
		Jugador palacios=new Jugador("Palacios","Defensa");
		Jugador rovira=new Jugador("Rovira","MedioCampista");
		Jugador mosquera=new Jugador("Mosquera","MedioCampista");
		Jugador mena=new Jugador("Mena","Delantero");
		Jugador quintero=new Jugador("Quintero","Defensa");
		...
		Equipo equipo1=new Equipo("Medellín",3);
		...
		Equipo equipo2=new Equipo("Nacional",5);
		equipo2.setJugadores(barcos);
		equipo2.setJugadores(duarte);
		equipo2.setJugadores(cepellini);
		equipo2.setJugadores(cuadrado);
		equipo2.setJugadores(palacios);
		equipo2.setJugadores(rovira);
		equipo2.setJugadores(mosquera);
		equipo2.setJugadores(mena);
		equipo2.setJugadores(quintero);
		...
		Equipo equipo3=new Equipo("Cali",1);
		...
		Equipo equipo4=new Equipo("América",0);
